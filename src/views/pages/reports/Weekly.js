...
const people = [
  {
    name: 'Jane Cooper',
    title: 'New Software required in lab',
  ...
  {
    name: 'Jane Cooper',
    title: 'Lab 11 PC 1O CPU is not working',
    department: 'Optimization',
    role: 'Lab Staff',
    email: 'jane.cooper@example.com',
    image:
  ...
  {
    name: 'Jane Cooper',
    title: 'Some mouse need to be replaced in lab 1',
  ...
  {
    name: 'Jane Cooper',
    title: 'LCD of PC 1 and 5 is not working in lab 12',
    department: 'Hardware Replacement',
    role: 'Lab Staff',
    email: 'jane.cooper@example.com',
    image:
      'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60',
